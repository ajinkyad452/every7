...
<html class="no-js" lang="en">
    <head>
        <!-- title -->
        <title>Every7.xyz – New Products @Every 7 Hours</title>
        <meta charset="utf-8" />
                                            ...
                                            <div class="display-table height-100 width-100">
                                                <div class="display-table-cell height-100 width-100 vertical-align-middle padding-fourteen-lr alt-font link-style-2 sm-padding-seven-lr xs-padding-15px-lr">
                                                    ...
                                                    <ul class="font-weight-500 xs-no-padding-left">
                                                        <!-- start menu item -->
                                                        <li class="dropdown">
                                                            <a href="#">Home</a><span data-toggle="dropdown" class="dropdown-toggle"></span>
                                                        </li>
                                                        <!-- end menu item -->
                                                        <!-- start menu item -->
                                                        <li class="dropdown">
                                                        ...
                                                        <!-- start menu item -->
                                                        <li class="dropdown">
                                                            <a href="javascript:void(0);">Contact Us</a><span data-toggle="dropdown" class="dropdown-toggle"></span>
                        ...
                        <div class="swiper-slide width-550px xs-width-100 xs-height-auto">
                            <div class="position-relative width-90 height-100 display-table padding-ten-all xs-padding-fifteen-all xs-width-100">
                                <div class="display-table-cell vertical-align-middle">
                                    <h4 class="text-medium-gray font-weight-400 display-block margin-5px-bottom alt-font">Hello,</h4>
                                    <h6 class="text-medium-gray font-weight-300 margin-20px-bottom alt-font">Welcome to Every7</h6>
                                    <p class="text-large dispaly-block pull-left font-weight-300 width-90 margin-35px-bottom">You can find new product after every 7 hours. So hurry up an purchase the product before its too late.</p>
                                    <!-- <img src="../assets/images/signature.png" class="width-60 signature" alt="" /> -->
                            ...
                            <div class="height-100 display-table">
                                <div class="display-table-cell vertical-align-middle">
                                    <div class="display-block position-relative">
                                        ...
                                        <p class="bottom-text width-100 text-extra-small text-white text-uppercase text-center">{{$product['body']}}</p>
                                    </div>
